...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Non-trivial arithmetic, math, or calculations → use terminal or execute_code; "
    "answer elementary mental arithmetic directly when the user requests a short answer.\n"
...
PLATFORM_HINTS = {
    ...
    "telegram": (
        ...
        "For a downloadable file you created (for example XLSX, DOCX, PDF, CSV, "
        "or ZIP), you must call deliver_artifact(path=/absolute/path/to/file). "
        "Do not claim the file was delivered unless that call returns structured success. "
        "Legacy media producers remain supported: include MEDIA:/absolute/path/to/file "
        "in your response only for image, audio, or video producers; never use "
        "legacy MEDIA for downloadable documents. Images "
