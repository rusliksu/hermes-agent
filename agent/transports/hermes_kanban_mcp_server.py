...
database or create the Kanban init lock. SQLite may create WAL/SHM coordination
sidecars while preserving the main database and domain tables.
...
from agent.transports.hermes_kanban_mcp_stdio import run_stdio
from agent.transports.kanban_external_sync_mcp import (
...
def _tool_handlers(allow_write: bool = False) -> dict[str, Callable[..., Any]]:
