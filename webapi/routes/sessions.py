...
from webapi.deps import WEB_SOURCE, ensure_session_title, get_session_db_dependency, new_session_id
...
async def search_sessions(
    ...
    session_db: Annotated[SessionDB, Depends(get_session_db_dependency)] = None,
) -> SearchSessionsResponse:
