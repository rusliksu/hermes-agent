...
from webapi.deps import reload_memory_store_dependency
...
async def get_memory(
    ...
    store: Annotated[MemoryStore, Depends(reload_memory_store_dependency)] = None,
) -> MemoryReadResponse:
    if target == "all":
...
async def add_memory(
    ...
    store: Annotated[MemoryStore, Depends(reload_memory_store_dependency)],
) -> MemoryMutationResponse:
